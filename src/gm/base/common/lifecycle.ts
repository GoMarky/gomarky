import { once } from '@/gm/base/common/functional';

export class DisposableError extends Error {
  public readonly name = 'DisposableError';
}
...
export class DisposableStore implements IDisposable {
  ...
  public add<T extends IDisposable>(t: T): T {
    ...
    if (((t as any) as DisposableStore) === this) {
      throw new DisposableError('Cannot register a disposable on itself!');
    }
...
export abstract class Disposable implements IDisposable {
  static None = Object.freeze<IDisposable>({
...
export class UnownedDisposable<T extends IDisposable> extends Disposable {
  ...
  public acquire(): T {
    if (this._hasBeenAcquired) {
      throw new DisposableError('This disposable has already been acquired');
    }
...
export abstract class ReferenceCollection<T> {
  ...
  public acquire(key: string): IReference<T> {
